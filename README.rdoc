...
You need RedCloth, CodeRay and redclothcoderay of course.  And Rails.
...
== Usage
  ...
  >> story.description = "<source:ruby>puts \"hello, world\"</source>"
  => "<source:ruby>puts \"hello, world\"</source>"
  >> story.description 
  => "<code class=\"inline_code\">puts <span class=\"s\"><span class=\"dl\">&quot;</span><span class=\"k\">hello, world</span><span class=\"dl\">&quot;</span></span></code>"
